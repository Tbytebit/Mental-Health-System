...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult getBatchUserInfo(@RequestParam(value = "userIds[]", required = false) List<Long> userIds)
    {
        ...
        List<SysUser> users = userIds.stream()
                .map(userId -> userService.selectUserById(userId))
    ...
    public R getUserInfo(@PathVariable(value = "userId", required = false) Long userId,

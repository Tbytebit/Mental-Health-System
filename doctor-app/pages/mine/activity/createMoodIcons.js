 ...
 * 创建心情图标文件
 * 
 * 该脚本用于生成心情图标的Data URL，
 * 开发人员可以使用这些Data URL保存为图片文件，放置在/static/images/mood/目录下
 */
...
`<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M42.7 35.4H17.3C16.58 35.4 16 36.07 16 36.9C16 44.21 22.27 50 30 50C37.73 50 44 44.21 44 36.9C44 36.07 43.42 35.4 42.7 35.4Z" fill="#FFFFFF"/>
...
/**
 * 使用方法：
 * 1. 在浏览器开发者工具Console中执行以下代码
 * 2. 将生成的Data URL复制后在新标签页中打开
 * 3. 右键保存图片到本地，并放在static/images/mood/目录下
 * 
 * 示例代码：
 * // 创建SVG图像的Data URL（Base64格式）
 ...
 * 
 * // 心情图标
 * console.log("开心图标:", svgToDataURL(moodIcons.happy));
 * console.log("平静图标:", svgToDataURL(moodIcons.neutral));
 * console.log("难过图标:", svgToDataURL(moodIcons.sad));
 * console.log("生气图标:", svgToDataURL(moodIcons.angry));
 * console.log("焦虑图标:", svgToDataURL(moodIcons.anxious));
 * 
 * // 空状态图像
 * console.log("空状态图像:", svgToDataURL(emptyDiary));
 */

// 导出图标数据
export { moodIcons, emptyDiary }; 